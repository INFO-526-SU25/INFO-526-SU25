...
A popular (and increasingly standard) way for sharing your analyses and visualizations is to post an annotated explanation of your process somewhere online. RStudio allows you to publish knitted HTML files directly to [RPubs](http://rpubs.com/)[^1], but you can also post your output to a blog or other type of website.[^2] Reading these kinds of posts is one of the best ways to learn R, since they walk you through each step of the process *and* show the code and output.

[^1]: In this course, we use [GitHub pages](https://pages.github.com/), since all assignments are GitHub repos. GitHub allows one website free for each public repo.

[^2]: In this course, we use [Quarto](https://quarto.org/), which makes a complete website with .qmd Quarto files. That's actually how this site is built ([see the source code](https://github.com/INFO-526-SU24/INFO-526-SU24)). You can build your own site [with this tutorial](https://quarto.org/docs/websites/).
