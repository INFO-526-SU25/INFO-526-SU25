---
title: "INFO 526 Syllabus Summer 2025"
format: 
  html: default
  pdf: default
---
...
635-2252-7W1 INFO 526 102 202 -- Data Analysis and Visualization
...
-   **Reading quizzes** (4), due every other week (roughly), completed individually. Each quiz is worth 2.5% of the grade.
...
-   **Use of generative artificial intelligence (AI)**: You should treat generative AI, such as ChatGPT, the same as other online resources. There are two guiding principles that govern how you can use AI in this course[^1]:
...
-   **Monday, May 19:** Classes begin, asynchronously
-   **Friday, June 27:** Last day of classes and examinations

For more important dates, see the full [UArizona Academic Calendar](https://archive.catalog.arizona.edu/2022-23/2024-2025-academic-calendar.html).
