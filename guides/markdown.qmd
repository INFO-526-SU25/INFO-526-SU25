...
+-------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+
| `![Image caption](path/to/image.png)`                                                                 | ![Image caption](images/logo.png){width="30%"}                              |
+-------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+
...
| ````                                                                                                  |                                                                             |
+-------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+
| Optionally specify [a language](https://github.com/jgm/skylighting/tree/master/skylighting-core/xml): |                                                                             |
+-------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+
| ```` default                                                                                          | ``` r                                                                       |
| ``` r                                                                                                 | x <- c(1, 3, 5, 7)                                                          |
| x <- c(1, 3, 5, 7)                                                                                    | plot(x)                                                                     |
...
> <li id="fn1">
>
> <p>This is a note.<a href="#fnref1" class="footnote-back">↩︎</a></p>
>
> </li>
>
> <li id="fn2">
>
> <p>DAGs are neat.<a href="#fnref2" class="footnote-back">↩︎</a></p>
>
> </li>
>
> </ol>
...
> <li id="fn3">
>
> <p>But it can be hard too!<a href="#fnref3" class="footnote-back">↩︎</a></p>
>
> </li>
>
> </ol>
...
3.  Cite things in your document. [Check the documentation for full details of how to do this](https://rmarkdown.rstudio.com/authoring_bibliographies_and_citations.html). Essentially, you use `@citationkey` inside square brackets (`[]`):
    ...
    | Type...                                            | ...to get...                                                                                |
    +====================================================+=============================================================================================+
    | ``` default                                        | Causal inference is neat (Rohrer 2018; Angrist and Pischke 2015).                           |
    | Causal inference is neat [@Rohrer:2018;            |                                                                                             |
    | @AngristPischke:2015].                             |                                                                                             |
    | ```                                                |                                                                                             |
    +----------------------------------------------------+---------------------------------------------------------------------------------------------+
    | ``` default                                        | Causal inference is neat (see Rohrer 2018, 34; also Angrist and Pischke 2015, chap. 1).     |
    | Causal inference is neat [see @Rohrer:2018, p. 34; |                                                                                             |
    | also @AngristPischke:2015, chapter 1].             |                                                                                             |
    | ```                                                |                                                                                             |
    +----------------------------------------------------+---------------------------------------------------------------------------------------------+
    | ``` default                                        | Angrist and Pischke say causal inference is neat (2015; see also Rohrer 2018).              |
    | Angrist and Pischke say causal inference is neat   |                                                                                             |
    | [-@AngristPischke:2015; see also @Rohrer:2018].    |                                                                                             |
    | ```                                                |                                                                                             |
    +----------------------------------------------------+---------------------------------------------------------------------------------------------+
    | ``` default                                        | Angrist and Pischke (2015, chap. 1) say causal inference is neat, and Rohrer (2018) agrees. |
